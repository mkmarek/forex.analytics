...
bool findStrategyValidateInput(const Nan::FunctionCallbackInfo<v8::Value>& args)
{
	...
	v8::Handle<v8::Object> configuration = getObjectFromArguments(args, 2);
...
NAN_METHOD(findStrategy)
{
	if (findStrategyValidateInput(info))
	{
		...
		v8::Handle<v8::Array> closeValuesArray = getArrayFromArguments(info, 0);
		v8::Handle<v8::Object> indicatorValuesObject = getObjectFromArguments(info, 1);
